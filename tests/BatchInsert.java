...
import btree.QuadrupleBTFileScan;
...
//			System.out.println("inserted subject :"+subject.getLabelKey());
			...
			sysdef.JavabaseDB.insertQuadruple(t.getQuadrupleByteArray());
		}
		...
		QuadrupleBTreeFile Quadruple_BTreeIndex = new QuadrupleBTreeFile(sysdef.JavabaseDB.name+"/Quadruple_BTreeIndex");
		QuadrupleBTFileScan scan = Quadruple_BTreeIndex.new_scan(null, null);
