...
//import btree.*;
  ...
  /**
   * Interface of a quadruple B+ tree index header page.  
   ...
   */
class QuadrupleBTreeHeaderPage extends THFPage {
   ...
   */
  public QuadrupleBTreeHeaderPage(PageId pageno) 
  ...
  public QuadrupleBTreeHeaderPage(Page page) {
   ...
   */
  public QuadrupleBTreeHeaderPage( ) 
    throws ConstructPageException
    {
      super();
      try{
...
} // end of QuadrupleBTreeHeaderPage
