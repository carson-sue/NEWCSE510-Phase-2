...
/**
 * A QuadrupleBTLeafPage is a leaf page on a label B+ tree.  It holds abstract 
...
public class QuadrupleBTLeafPage extends QuadrupleBTSortedPage {
   ...
   *@param dataTid - the lid of the data record. This is
   ...
   */   
  public QID insertRecord(KeyClass key, QID dataTid) 
