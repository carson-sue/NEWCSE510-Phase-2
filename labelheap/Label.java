...
//	       fldOffset = fromLabel.copyFldOffset(); 
	   ...
	   public void LabelInit(byte [] atuple, int offset, int length)
	   {
	      data = atuple;
	      label_offset = offset;
	      label_length = length;
	...
	/** get the length of a tuple, call this method if you did 
	  ...
	  */
	  public short size()
	   ...
	   {
	       byte [] tuplecopy = new byte [label_length];
	       System.arraycopy(data, label_offset, tuplecopy, 0, label_length);
	       return tuplecopy;
	   }
