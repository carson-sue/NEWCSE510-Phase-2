...
public class QuadruplepnodeSplayPQ extends QuadruplepnodePQ
{
  ...
  */
	 ...
	 * @exception QuadrupleUtilsException error in tuple compare routines
	 */
	public void Quadrupleenq(Quadruplepnode item) throws
		IOException, UnknowAttrType, QuadrupleUtilsException 
		{
			count ++;
