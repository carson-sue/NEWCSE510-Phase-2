...
/**
 *QuadrupleOBuf::Put takes quadruples and stores them on the buffer pages that
 *were passed to QuadrupleOBuf::init.  QuadrupleOBuf::flush inserts them enmass into
 *a temporary Quadruple HeapFile.
 */
public class QuadrupleOBuf implements GlobalConst
{
  ...
  /**
   * Quadruple_O_buf is an output buffer. It takes as input:
  ...
  */
  public void init(byte[][] bufs, int n_pages, QuadrupleHeapfile temp_fd, boolean buffer)
  {
	  _bufs    = bufs;
	  _n_pages = n_pages;
